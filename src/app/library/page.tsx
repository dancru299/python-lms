...
export default async function LibraryPage() {
  ...
  // Logged-in students see the library inside the consistent panel shell.
    ...
    return (
      <StudentShell userName={session.name} notificationCount={notificationCount}>
        <StudentPageFrame
          ...
          subtitle="Toàn bộ bài giảng Python đã công bố — đọc trước hoặc ôn lại bất cứ lúc nào."
          summaryPills={[
            { label: "Chương", value: chapters.length, tone: "indigo" },
            { label: "Bài giảng", value: totalLessons, tone: "emerald" },
          ]}
        >
          {chapterListing}
        </StudentPageFrame>
  ...
  // Guests (and non-student roles) get the standalone public page.
  return (
